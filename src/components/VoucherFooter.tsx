  ...
  return (
    <div className={cn("p-6 bg-black text-white rounded-b-lg", className)}>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          <h4 className="text-sm font-semibold mb-2 text-rentalOrange-100">Precisa de Ajuda?</h4>
        ...
        <div>
          <h4 className="text-sm font-semibold mb-2 text-rentalOrange-100">Políticas de Aluguel</h4>
          <div className="text-sm space-y-1">
      ...
      <Separator className="my-4 bg-rentalOrange-800" />
