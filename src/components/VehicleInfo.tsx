...
const VehicleInfo: React.FC<VehicleInfoProps> = ({ className }) => {
  return (
    <div className={cn("p-6 bg-rentalGray-50", className)}>
      <h3 className="text-lg font-semibold text-rentalBlue-900 mb-4">Vehicle Information</h3>
        ...
        <div className="w-full md:w-1/3">
          <div className="bg-white border border-rentalGray-200 rounded-md p-4 h-full">
            ...
            <div className="text-center">
              <div className="text-xs text-rentalGray-500 uppercase">Your vehicle (or similar)</div>
              <div className="text-xl font-bold text-rentalBlue-900">Toyota Camry</div>
              <div className="text-sm text-rentalGray-600">Midsize Sedan</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-2/3">
          <div className="bg-white border border-rentalGray-200 rounded-md p-5 h-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-3">
              ...
              <div className="flex items-center">
                <CheckIcon className="w-4 h-4 text-rentalBlue-600 mr-2" />
                <span className="text-sm">2 Large Suitcases</span>
              </div>
              <div className="flex items-center">
                <CheckIcon className="w-4 h-4 text-rentalBlue-600 mr-2" />
            ...
            <div className="mt-5 pt-5 border-t border-rentalGray-200">
              ...
              <div className="flex justify-between items-center mb-2">
                <div className="text-sm font-medium">Included Mileage:</div>
                <div className="text-sm">Unlimited</div>
              </div>
              <div className="flex justify-between items-center">
                <div className="text-sm font-medium">Fuel Policy:</div>
                <div className="text-sm">Full to Full</div>
              </div>
            </div>
          </div>
        </div>
